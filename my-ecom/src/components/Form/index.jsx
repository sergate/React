...
export default function Form() {
  const { name, surname, email, tel, adress, postalCode, setName, setSurname, setEmail, setTel, setAdress, setPostalCode, handleClickBuyButton } = useCartContext();
  ...
  return (
    <>
      ...
      >
        ...
        <TextField style={{ width: 450 }} id="outlined-number" label="Teléfono / Celular" type="number" InputLabelProps={{shrink: true,}} defaultValue={tel} onChange={(e) => setTel(e.target.value)}/>
